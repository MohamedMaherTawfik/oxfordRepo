                ...
                <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="lg:w-2/3 {{ app()->getLocale() === 'ar' ? 'lg:order-1 text-right' : 'lg:order-1 text-left' }}">
                        ...
                        <div x-show="activeTab === 'schedule'" class="bg-white rounded-lg shadow-sm p-6 mb-6">
                            ...
                            <!-- Payment Buttons -->
                            <div x-show="canShowPayment()" class="mt-6 flex flex-wrap gap-4 {{ app()->getLocale() === 'ar' ? 'justify-center flex-row-reverse' : 'justify-center' }}">
                                @if ($visaenables && $visaenables->visa_enable == 1)
                                    @guest
                                        <form action="{{ route('pay.form.login', [$course, 'visa']) }}" method="post">
                                            ...
                                            <button type="submit" class="px-6 py-3 bg-[#79131d] text-white font-semibold rounded-lg hover:bg-[#5a0f16] transition-colors">
                                ...
                                @if ($visaenables && $visaenables->cash_enable == 1)
                                    @guest
                                        <form action="{{ route('pay.form.login', [$course, 'cash']) }}" method="post">
                                            ...
                                            <button type="submit" class="px-6 py-3 bg-[#e4ce96] text-[#79131d] font-semibold rounded-lg hover:bg-[#d4be86] transition-colors">
