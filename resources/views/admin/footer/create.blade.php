<x-panel>
    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="bg-white shadow-lg rounded-xl p-8 w-full max-w-4xl">
            ...
            <form action="{{ route('admin.footers.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="whatsapp" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Telegram -->
                    <div>
                        <label class="block text-gray-700">Telegram</label>
                        <input type="text" name="telegram" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Facebook -->
                    <div>
                        <label class="block text-gray-700">Facebook</label>
                        <input type="text" name="facebook" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Instagram -->
                    <div>
                        <label class="block text-gray-700">Instagram</label>
                        <input type="text" name="instgram" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- X (Twitter سابقاً) -->
                    <div>
                        <label class="block text-gray-700">X</label>
                        <input type="text" name="x" class="w-full border rounded-lg px-3 py-2">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="google_play" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- App Store -->
                    <div>
                        <label class="block text-gray-700">App Store</label>
                        <input type="text" name="app_store" class="w-full border rounded-lg px-3 py-2">
                    </div>
                </div>
