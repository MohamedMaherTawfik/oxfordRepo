    ...
    <div class="max-w-5xl mx-auto mt-10 space-y-10">
            ...
            <table class="table-auto w-full text-sm border border-gray-200">
                ...
                <tbody>
                    <tr class="text-gray-800">
                        ...
                        <td class="px-4 py-2 border">{{ $quiz->duration }} {{ __('teacher.minutes') }}</td>
                        <td class="px-4 py-2 border">{{ $quiz->start_at }}</td>
                        <td class="px-4 py-2 border">{{ $quiz->end_at }}</td>
                        <td class="px-4 py-2 border">{{ $quiz->user->name ?? __('teacher.n_a') }}</td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="bg-white shadow rounded p-6">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-xl font-bold">{{ __('teacher.questions') }}</h2>
                ...
                <table class="w-full table-auto border border-gray-200">
                    <thead class="bg-gray-100 text-gray-700">
                        <tr>
                            ...
                            <th class="px-4 py-2 border text-center">{{ __('teacher.actions') }}</th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2 border text-center">
                                    <form
                                        ...
                                        onsubmit="return confirm('{{ __('teacher.delete_question_confirm') }}');">
                                        @csrf
                                        @method('DELETE')
