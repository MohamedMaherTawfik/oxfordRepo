                ...
                <div class="flex-1 flex justify-center">
                    <div x-data="{ dropdownOpen: false, modalOpen: false }" class="relative">
                        <button @click="dropdownOpen = !dropdownOpen"
                            ...
                            <span>{{ __('teacher.options') }}</span>
                            <i class="fas fa-chevron-down text-xs transition-transform duration-200" :class="{ 'rotate-180': dropdownOpen }"></i>
                        </button>

                        <!-- Dropdown Menu -->
                        <div x-show="dropdownOpen" @click.away="dropdownOpen = false" x-transition x-cloak
                            class="absolute left-1/2 transform -translate-x-1/2 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 overflow-hidden">
                            <div class="py-2">
