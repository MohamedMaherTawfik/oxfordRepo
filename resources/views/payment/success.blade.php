...
<body
    class="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden success-animation">
                ...
                <div class="inline-block relative">
                    <svg class="w-24 h-24 text-white" viewBox="0 0 52 52">
                        <circle class="checkmark-circle" cx="26" cy="26" r="25" fill="none"
                            stroke="currentColor" stroke-width="3" stroke-dasharray="166" stroke-dashoffset="166" />
                        <path class="checkmark" fill="none" stroke="currentColor" stroke-width="3"
                            stroke-dasharray="36" stroke-dashoffset="36" d="M14.1 27.2l7.1 7.2 16.7-16.8" />
                    </svg>
                </div>
            ...
            <div class="p-8">
                <div
                    class="bg-gradient-to-r from-[#79131d]/5 to-[#5a0f16]/5 rounded-xl p-6 mb-6 border border-[#79131d]/10">
                    <h2
                    ...
                    <div class="space-y-3">
                        <div
                            ...
                            <span
                                class="text-gray-600 font-medium {{ app()->getLocale() === 'ar' ? 'text-right' : 'text-left' }}">
                                {{ __('messages.course') ?? 'Course' }}:
                            </span>
                            <span
                                class="text-gray-900 font-semibold {{ app()->getLocale() === 'ar' ? 'text-right' : 'text-left' }}">
                                {{ $course->title }}
                            </span>
                        </div>
                        <div
                            ...
                            <span
                                ...
                                @if (app()->getLocale() === 'ar')
                                    ...
                                    <img src="https://www.sama.gov.sa/ar-sa/Currency/Documents/Saudi_Riyal_Symbol-2.svg"
                                        alt="SAR" class="inline-block w-5 h-5 ml-1"
                                        style="vertical-align: middle;">
                                @else
                                    <img src="https://www.sama.gov.sa/ar-sa/Currency/Documents/Saudi_Riyal_Symbol-2.svg"
                                        alt="SAR" class="inline-block w-5 h-5 mr-1"
                                        style="vertical-align: middle;">
                                    {{ number_format($course->admin_price > 0 ? $course->admin_price : $course->price, 2) }}
                                @endif
                            </span>
                ...
                <!-- Action Buttons -->
                <div
                    class="flex flex-col sm:flex-row gap-4 {{ app()->getLocale() === 'ar' ? 'sm:flex-row-reverse' : '' }}">
                ...
                <!-- Additional Info -->
                <div
                    class="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg {{ app()->getLocale() === 'ar' ? 'text-right' : 'text-left' }}">
