@php
    ...
    $course_4 = Diplomas::inRandomOrder()->take(4)->get()->reverse();
    $newest = Diplomas::orderBy('created_at', 'desc')->take(4)->get();
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach ($course_4 as $item)
                <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
                    ...
                    <img src="{{ $imagePath }}" alt="{{ $item->title }}" class="w-full h-48 object-cover">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex justify-center {{ $isArabic ? 'space-x-reverse space-x-3' : 'space-x-3' }}">
                            <a href="{{ route('gate.diplomas.show', $item->slug) }}"
                            ...
                            @if ($item->user_id == auth()->id())
                                <a href="{{ route('gate.diplomas.show.diploma', $item->slug) }}"
